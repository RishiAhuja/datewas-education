...
class UploadingForm extends StatefulWidget {
  ...
  UploadingForm({@required this.collection, @required this.classInt});
...
class _UploadingFormState extends State<UploadingForm> {
  ...
  async{
    try {
      ...
      print('${widget.classInt}thSolution');
      ...
      if(widget.collection == '${widget.classInt}thQuestionBank')
      {
        databaseMethods.questionUpload(widget.classInt, userMap);
      }
      if(widget.collection == '${widget.classInt}S1')
      {
        databaseMethods.syllabus1(widget.classInt, userMap);
      }
      if(widget.collection == '${widget.classInt}S2')
      {
        databaseMethods.syllabus2(widget.classInt, userMap);
      }
      if(widget.collection == '${widget.classInt}TM')
      {
        databaseMethods.textMaterial(widget.classInt, userMap);
      }
      if(widget.collection == '${widget.classInt}PYQ')
      {
        databaseMethods.PYQ(widget.classInt, userMap);
      }
  ...
  void initState() {
    ...
    if(widget.collection == '${widget.classInt}S1' || widget.collection == '${widget.classInt}S2')
      {
        _isSyllabus = true;
      }
    super.initState();
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      _selectedFiles.length != 0 || _isSyllabus  ? GestureDetector(
                        onTap: () {
                          uploadLoop();
                          showDialog(
